...
public class OphthaApplication extends Application {
    ...
    public void onCreate() {
        ...
        patientData.setLastName("Крыгин");
        patientData.setPatronymic("Александрович");
...
//        patientObject.setGender(PatientData.Gender.M.toBoolean());
...
//
//
//        patientObject.getExamination().add(examinationObject);
//        patientObject.getExamination().add(examinationObject1);
//
